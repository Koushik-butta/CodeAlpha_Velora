...
def seed_products():
    ...
    products_to_create = [
        ...
        },
        {
            'category_slug': 'mobiles',
            'seller_email': 'official.stores@velora.in',
            'title': 'OnePlus 12 5G (Flowy Emerald, 16GB RAM, 256GB Storage)',
            'price': 59999,
        ...
        },
        {
            'category_slug': 'fashion',
            'seller_email': 'official.stores@velora.in',
            'title': 'Levi\'s Men\'s 501 Original Fit Denim Jeans',
            'price': 3199,
            'original_price': 4599,
            'listing_type': 'buy',
            'condition': 'new',
            'brand': 'Levi\'s',
            'model_name': '501 Original',
            'city': 'Bengaluru',
            'state': 'Karnataka',
        ...
        # --- Second Hand / Pre-owned ---
        {
            'category_slug': 'fashion',
            'seller_email': 'ananya.sen@gmail.com',
            'title': 'US Polo Assn Men\'s Brown Leather Sneakers',
            'price': 1799,
            'original_price': 3999,
            'listing_type': 'sell',
            'condition': 'like_new',
            'brand': 'USPA',
            'model_name': 'Leather Sneaker',
            'city': 'Pune',
            'state': 'Maharashtra',
        ...
        # --- Brand New ---
        {
            ...
            'seller_email': 'official.stores@velora.in',
            'title': 'Wakefit Ergonomic Office Chair with Adjustable Armrests',
            'price': 5999,
            'original_price': 8999,
            'listing_type': 'buy',
            'condition': 'new',
